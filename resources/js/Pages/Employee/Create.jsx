...
const Create = ({ companies }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const phoneRegex = /^(0\d{9}|(\+233|233)\d{9})$/;

        if (!phoneRegex.test(data.phone)) {
            toast.error("Invalid phone number entered. Please enter a valid phone number.");
            return;
        }
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="flex justify-between items-center p-6 w-4/5 mx-auto">
                            <div>
                                <h2 className="font-semibold text-xl text-gray-800 leading-tight">Create New Employee</h2>
                            </div>
                            ...
                            <div className="w-4/5 mx-auto">
                                <form onSubmit={handleSubmit}>
                                    <div className="w-full mb-4">
                                        ...
                                        <InputError>{errors.company_id}</InputError>
                                    </div>
                                    <div className="w-full mb-4">
                                    ...
                                    <div className="w-full mb-4">
                                        <InputLabel htmlFor="photo" value="Upload Photo" className='font-semibold text-gray-800 mb-2' />
                                        <input
                                            id="photo"
                                            name="photo"
                                            type="file"
                                            ...
                                            className='w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm'
                                        />
                                        <InputError>{errors.photo}</InputError>
                                    </div>
                                    <div className="w-full mb-4">
